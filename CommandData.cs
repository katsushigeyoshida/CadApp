...
namespace CadApp
{
    ...
    public enum OPERATION { non, loc, pic,
        ...
        createArc, createCircle, createEllipse, createText, createArrow,
        createLabel, createLocDimension, createDimension, createAngleDimension,
        createDiameterDimension, createRadiusDimension,

        translate, rotate, mirror, trim, divide, stretch, offset, disassemble, textChange, changeProperty,
